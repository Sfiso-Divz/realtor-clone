        ...
        <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
            ...
            <div >
                <ul className='flex space-x-10'>
                    ...
                    <li className={` cursor-pointer py-3 text-sm text-gray-400 border-b-[3px] border-transparent ${ (pathMatchRoute("/sign-in") || pathMatchRoute("/profile")) && "text-black font-semibold border-b-red-500"}`} onClick={() => navigate("/profile")}>{ pageState}</li>
                </ul>
            </div>
        </header>
    </div>
